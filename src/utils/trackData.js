...
// Silverstone GP: clockwise from the Hamilton straight through Abbey, the
// Arena loop, Brooklands/Luffield, Copse, Maggotts-Becketts, Stowe and Club.
// Digitized from the official F1 map, uniformly scaled for arcade lap times.
// Arena and Vale are rounded locally to keep full-width barriers continuous.
const silverstoneGrandPrixPoints = [
  [452, 99],
  [515, 146],
  [577, 192],
  [595, 209],
  ...
  [390, 54],
  [415, 71],
].map(([x, z]) => new THREE.Vector3((x - 605) * 0.62, TRACK_CENTERLINE_Y, (z - 318) * 0.62));
...
export const TRACK_PRESETS = Object.freeze([
  ...
  createTrackPreset({
    ...
    inspiration: 'Silverstone Circuit · Great Britain',
    description: 'An open airfield circuit linking sweeping high-speed corners, the Arena loop and the Hangar straight.',
    fidelityMarkers: ['Maggotts-Becketts esses', 'Hangar straight', 'Arena loop', 'angular pit roof', 'open grass runoff'],
    points: silverstoneGrandPrixPoints,
    venue: 'silverstone',
    roadWidth: 16,
    reference: {
      circuit: 'Silverstone Circuit',
      source: 'https://www.formula1.com/en/racing/2025/great-britain',
      keyFeatures: ['18-turn silhouette', 'Arena loop', 'Copse', 'Maggotts-Becketts', 'Hangar straight'],
      sceneSource: 'https://www.formula1.com/en/latest/article/circuit-guide-everything-you-need-to-know-about-silverstone-2026.5Sl0O8g393enBWVIkjRzOr',
      sceneCues: ['open airfield', 'grass runoff', 'angular pit roof', 'low grandstands', 'overcast daylight'],
    },
    theme: {
      groundColor: '#64804c',
      roadColor: '#353938',
    ...
    environment: {
      ...
      hemisphereSkyColor: '#d7e5ec',
      hemisphereGroundColor: '#66744c',
